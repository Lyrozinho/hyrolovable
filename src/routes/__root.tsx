...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Hyro Admin - Admin" },
      { name: "description", content: "Painel administrativo para gerenciamento de chaves de licença e revendedores." },
      { property: "og:title", content: "Hyro Admin - Admin" },
      { property: "og:description", content: "Painel administrativo para gerenciamento de chaves de licença e revendedores." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:title", content: "Hyro Admin - Admin" },
      { name: "twitter:description", content: "Painel administrativo para gerenciamento de chaves de licença e revendedores." },
      { property: "og:image", content: "https://storage.googleapis.com/gpt-engineer-file-uploads/attachments/og-images/709e06b8-0577-4cd1-b1b1-74097a7f9689" },
      { name: "twitter:image", content: "https://storage.googleapis.com/gpt-engineer-file-uploads/attachments/og-images/709e06b8-0577-4cd1-b1b1-74097a7f9689" },
    ],
    links: [
      {
        rel: "stylesheet",
