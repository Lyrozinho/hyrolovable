...
import { LayoutDashboard, KeyRound, Users, LogOut, ChevronsLeft, ChevronsRight, GraduationCap, Rocket, Bot, Plug, Download, Loader2, UserPlus } from "lucide-react";
...
const items: NavItem[] = [
  ...
  { title: "Afiliado", url: "/affiliate", icon: UserPlus, roles: ["admin", "client"], resellerOrAdminOnly: true },
  ...
  return (
    <>
      ...
      >
        <div
          className={[
            "rounded-xl overflow-hidden shrink-0 ring-1 ring-white/10 shadow-[0_8px_24px_-8px_rgba(139,92,246,0.55)]",
